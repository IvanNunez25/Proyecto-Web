...
switch ($tipoArtista) {
    case '1':
        ...
        break;
    case '2':
        $tipoArtista = "BoyGroup";
        break;
    case '3':
        $tipoArtista = "GirlGroup";
        break;
    case '4':
        $tipoArtista = "Solista Masculino";
        break;
    case '5':
        $tipoArtista = "Solista Femenina";
        break;
    case '6':
        $tipoArtista = "Duo";
        break;
    case '7':
        $tipoArtista = "Grupo Mixto";
        break;
}
        ...
        <div class="detalles-compra">
            ...
            <div class="detalles-alineacion">
                ...
                <script>
                    paypal.Button.render({
                        ...
                        onAuthorize: function(data, actions) {
                            return actions.payment.execute().then(function() {
                                ...
                                ejecutarProcedimiento(<?php echo $disco_id ?>, <?php echo $cantidad ?>);
                    ...
                    function ejecutarProcedimiento(parametro1, parametro2) {
                        
                        const formData = new FormData();
                        formData.append('parametro1', parametro1);
                        formData.append('parametro2', parametro2);

                        fetch('PHP/ActualizarStock.php', {
                                method: 'POST',
                                body: formData
                            })
